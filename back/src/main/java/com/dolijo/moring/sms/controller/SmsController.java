...
public class SmsController {
    ...
    @Operation(summary = "운전자 응급상황 SMS 전송", description = "vin, 위치, 주소, 코드 정보를 포함한 SMS를 전송합니다.")
    ...
    @Operation(summary = "비인가 사용자 알림 SMS 전송", description = "vin, 위치, 주소, 비인가 운전자 이미지url을 포함한 SMS를 전송합니다.")
